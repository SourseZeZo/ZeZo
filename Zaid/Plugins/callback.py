...
from ZeZo import app, BOT_USERNAME, dbb, SUDOERS
import os
import yt_dlp
from youtubesearchpython import VideosSearch
from ZeZo.config import LOG_GROUP_ID
from ZeZo.MusicUtilities.tgcallsrun import ASS_ACC
from os import path
import random
...
from ZeZo import dbb, app, BOT_USERNAME, BOT_ID, ASSID, ASSNAME, ASSUSERNAME, ASSMENTION
from ZeZo.MusicUtilities.tgcallsrun import (music, convert, download, clear, get, is_empty, put, task_done, smexy)
from ZeZo.MusicUtilities.helpers.decorators import errors
from ZeZo.MusicUtilities.helpers.filters import command, other_filters
from ZeZo.MusicUtilities.helpers.paste import paste
from ZeZo.MusicUtilities.tgcallsrun import (music, clear, get, is_empty, put, task_done)
from ZeZo.MusicUtilities.database.queue import (is_active_chat, add_active_chat, remove_active_chat, music_on, is_music_playing, music_off)
from ZeZo.MusicUtilities.database.playlist import (get_playlist_count, _get_playlists, get_note_names, get_playlist, save_playlist, delete_playlist)
from ZeZo.MusicUtilities.database.assistant import (_get_assistant, get_assistant, save_assistant)
from ZeZo.MusicUtilities.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup, audio_markup)
from ZeZo.MusicUtilities.helpers.inline import play_keyboard, confirm_keyboard, play_list_keyboard, close_keyboard, confirm_group_keyboard
from ZeZo.MusicUtilities.tgcallsrun import (music, convert, download, clear, get, is_empty, put, task_done, smexy)
from ZeZo.MusicUtilities.database.queue import (is_active_chat, add_active_chat, remove_active_chat, music_on, is_music_playing, music_off)
from ZeZo.MusicUtilities.database.onoff import (is_on_off, add_on, add_off)
from ZeZo.MusicUtilities.database.blacklistchat import (blacklisted_chats, blacklist_chat, whitelist_chat)
from ZeZo.MusicUtilities.database.gbanned import (get_gbans_count, is_gbanned_user, add_gban_user, add_gban_user)
from ZeZo.MusicUtilities.database.theme import (_get_theme, get_theme, save_theme)
from ZeZo.MusicUtilities.database.assistant import (_get_assistant, get_assistant, save_assistant)
from ZeZo.config import DURATION_LIMIT, ASS_ID
from ZeZo.MusicUtilities.helpers.decorators import errors
from ZeZo.MusicUtilities.helpers.filters import command
from ZeZo.MusicUtilities.helpers.gets import (get_url, themes, random_assistant, ass_det)
from ZeZo.MusicUtilities.helpers.thumbnails import gen_thumb
from ZeZo.MusicUtilities.helpers.chattitle import CHAT_TITLE
from ZeZo.MusicUtilities.helpers.ytdl import ytdl_opts 
from ZeZo.MusicUtilities.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup)
import requests
from pyrogram.types import (
    CallbackQuery,
    InlineKeyboardButton,
...
from ZeZo import aiohttpsession as session
